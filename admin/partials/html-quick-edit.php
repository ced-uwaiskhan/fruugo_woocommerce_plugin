...
<form method="get">
	<table style="display: none">
		...
		<tr id="<?php esc_html_e($bulk) ? 'bulk-edit' : 'inline-edit'; ?>" class="inline-edit-row inline-edit-row-
						   <?php
							esc_html_e( "$hclass inline-edit-" . $screen->post_type);
							esc_html_e( $bulk ? " bulk-edit-row bulk-edit-row-$hclass bulk-edit-{$screen->post_type}" : " quick-edit-row quick-edit-row-$hclass inline-edit-{$screen->post_type}");
							?>
		" style="display: none"><td colspan="<?php esc_html_e($this->get_column_count()); ?>" class="colspanchange">

					<fieldset class="inline-edit-col-left">
						<div id="ced_fruugo_quick_edit" class="inline-edit-col">
							<div class="ced_fruugo_profile_field">
								<label>
									<span class="title"><?php esc_html_e( 'SKU', 'ced-fruugo' ); ?></span>
								</label>
							...
							<input type="hidden" name="ced_fruugo_quick_edit_nonce" value="<?php esc_html_e(wp_create_nonce( 'ced_fruugo_quick_edit_nonce' )); ?>" />
							<br class="clear" />
						</div>
					</fieldset>	
					<p class="submit inline-edit-save">
						<button type="button" class="button-secondary cancel alignleft"><?php esc_html_e( 'Cancel', 'ced-fruugo' ); ?></button>
						<?php
						if ( ! $bulk ) {
							wp_nonce_field( 'inlineeditnonce', '_inline_edit', false );
							?>
							<button type="button" class="button-primary save alignright"><?php esc_html_e( 'Update', 'ced-fruugo' ); ?></button>
