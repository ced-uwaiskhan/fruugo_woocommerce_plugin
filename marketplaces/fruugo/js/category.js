	...
	function(){
		...
		jQuery( document.body ).on(
			...
			function(){
				...
				var parentCatName = "";
				jQuery( document ).find( '.fruugo_cat_active' ).each(
					function(){
							...
							jQuery.each(
								...
								function( key, value )
								{
									...
									if ( savedCat[value] ) {
										...
										jQuery.each(
											alreadysavedcat,
											function( indexsaved, valuesaved ) {
												console.log(valuesaved);
												console.log(parentCatName+value);
