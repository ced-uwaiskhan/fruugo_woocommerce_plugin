...
class SheetManager {
	...
	public function getSheets() {
		...
		$xmlProcessor->registerCallback( self::XML_NODE_WORKBOOK_PROPERTIES, XMLProcessor::NODE_TYPE_START, array( $this, 'processWorkbookPropertiesStartingNode' ) );
		$xmlProcessor->registerCallback( self::XML_NODE_WORKBOOK_VIEW, XMLProcessor::NODE_TYPE_START, array( $this, 'processWorkbookViewStartingNode' ) );
		$xmlProcessor->registerCallback( self::XML_NODE_SHEET, XMLProcessor::NODE_TYPE_START, array( $this, 'processSheetStartingNode' ) );
		$xmlProcessor->registerCallback( self::XML_NODE_SHEETS, XMLProcessor::NODE_TYPE_END, array( $this, 'processSheetsEndingNode' ) );
