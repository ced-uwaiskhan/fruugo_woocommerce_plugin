...
class WriterEntityFactory {
	 ...
	 * @return Row
	 */
	public static function createRow( array $cells = array(), Style $rowStyle = null ) {
	 ...
	 * @return Row
	 */
	public static function createRowFromArray( array $cellValues = array(), Style $rowStyle = null ) {
		$cells = \array_map(
			function ( $cellValue ) {
